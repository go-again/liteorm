...
//
// Vendored from sqlc (github.com/sqlc-dev/sqlc, MIT License) protos/plugin/codegen.proto
// — the stable plugin codegen contract. Only the protobuf message types are
// copied; liteorm consumes GenerateRequest and emits GenerateResponse.
